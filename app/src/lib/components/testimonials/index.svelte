<script>
	...
	const testimonials = [
		[
			...
			{
				content: 'Я очень доволен своей покупкой кухонного гарнитура. Мебель оказалась не только красивой, но и очень качественной. Кухня стала выглядеть еще более стильной и привлекательной с этой мебелью. В общем рекомендую!!!',
				author: {
					name: 'Саня',
