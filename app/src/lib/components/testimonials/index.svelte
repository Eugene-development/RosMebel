<script>
	...
	const testimonials = [
		[
			...
			{
				content: 'Я очень доволен своей покупкой кухонного гарнитура. Мебель оказалась не только красивой, но и очень качественной. Кухня стала выглядеть еще более стильной и привлекательной с этой мебелью. Я очень рекомендую эту мебель другим людям, которые ищут красивый и качественный кухонный гарнитур.',
				author: {
					name: 'Саня',
		...
		[
			...
			{
				content: 'Давно мечтала о шкафе-купе, но не могла найти подходящий в магазинах. Но когда я узнала о возможности заказать мебель на заказ, решила попробовать. И я не пожалела! Нашла эту фирму. Шкаф превосходно соответствует моим пожеланиям и идеально вписывается в интерьер комнаты. Я очень довольна моей покупкой!',
				author: {
					name: 'Ася',
					role: '11 января 2023',
					image: avatarImage4
