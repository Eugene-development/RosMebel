        ...
        <div class="max-w-full">
          <div class="relative shadow-xl sm:overflow-hidden">
            <div class="absolute inset-0">
              <img class="h-full w-full object-cover" src={BC.pathImgBC} alt="рубрика">
						...
						<div class="flex">
							<div class="flex items-center">
								...
								<a
									...
									class="ml-4 text-sm font-medium text-gray-100 hover:text-gray-100">{BC.parentPage}</a
								>
							</div>
						</div>
					{/if}
					...
					<div class="flex">
						<div class="flex items-center">
							...
							<span
								...
								aria-current="page">{BC.currentPage}</span
							>
						</div>
					</div>
				</div>
          ...
          <div class="group">
            ...
            <span class="px-6 py-5 flex items-start text-sm font-medium">
              ...
              <span class="mt-0.5 ml-4 flex min-w-0 flex-col">
                ...
                <span class="text-sm font-medium text-gray-500">Оформите заявку на бесплатный замер на сайте или по телефону</span>
              </span>
            </span>
          </div>
        </div>
      ...
      <li class="relative overflow-hidden lg:flex-1">
        <div class="border border-gray-200 overflow-hidden lg:border-0">
          <div aria-current="step">
            <span class="absolute top-0 left-0 h-full w-1 bg-green-600 lg:bottom-0 lg:top-auto lg:h-1 lg:w-full" aria-hidden="true"></span>
            <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
              ...
              <span class="mt-0.5 ml-4 flex min-w-0 flex-col">
                ...
                <span class="text-sm font-medium text-gray-500">Получите полную консультацию с учётом размеров помещения</span>
              </span>
            </span>
          </div>
          ...
          <div class="group">
            ...
            <span class="px-6 py-5 flex items-start text-sm font-medium lg:pl-9">
              ...
              <span class="mt-0.5 ml-4 flex min-w-0 flex-col">
                ...
                <span class="text-sm font-medium text-gray-500">Оформите договор на поставку мебели в офисе или у вас дома</span>
              </span>
            </span>
          </div>
