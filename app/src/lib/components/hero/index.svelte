...
<div class="isolate bg-white">
  ...
  <main>
    ...
    <div class="relative px-6 lg:px-8">
      <div class="mx-auto max-w-7xl pt-10 pb-16 sm:pt-20 sm:pb-18">
        <div>
          <div class="hidden sm:mb-8 sm:flex sm:justify-center">
            <div class="relative overflow-hidden rounded-full py-1.5 px-4 text-sm leading-6 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              <span class="text-gray-600">
                Посетите наш мебельный блог <a href="/blog" class="font-semibold text-blue-600"><span class="absolute inset-0" aria-hidden="true"></span>Почитать <span aria-hidden="true">&rarr;</span></a>
              </span>
            </div>
          </div>
          <div>
		...
		>
            ...
            <div class="mt-8 flex gap-x-4 sm:justify-center">
              <a href="#catalog" class="inline-block rounded-lg bg-gradient-to-tr from-red-600 via-red-800 to-blue-600 hover:bg-gradient-to-bl px-4 py-1.5 text-base font-semibold leading-7 text-white shadow-sm ring-1">
                Посмотреть каталог
