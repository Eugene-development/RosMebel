// SEO
const title =
	`${import.meta.env.VITE_COMPANY_NAME}` + ' | Кухонные гарнитуры МДФ в Нижнем Новгороде';
...
const descriptionBC =
	'Ознакомьтесь с нашими вариантами кухонных гарнитуров с фасадами под плёнкой МДФ или в рамке';
const pathImgBC =
