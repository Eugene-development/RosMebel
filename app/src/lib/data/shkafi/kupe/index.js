...
const mainText = {
	titleCategory: 'Купе',
	descriptionCategory:
		'Недорогие качественные шкафы купе с использованием современной фурнитуры для плавного хода дверей. Есть варианты как прямых так и угловых шкафов купе. Выбирайте наиболее подходящее наполнение и внешний вид вместе с нашим замерщиком.'
};
