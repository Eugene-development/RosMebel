...
// Main
const service = 'Оплата';
const text =
	'Предлагаем удобные способы оплаты наличными или безналичным способом для организаций. На заказные позиции работаем по предоплате. В отдельных случаях возможна оплата в кредит через банк.';
const img =
